...
type ScoreRange int32

const (
	ScoreRange_anything   ScoreRange = 0
	ScoreRange_includeMin ScoreRange = 1
	ScoreRange_includeMax ScoreRange = 2
)

// Enum value maps for ScoreRange.
var (
	ScoreRange_name = map[int32]string{
		0: "anything",
		1: "includeMin",
		2: "includeMax",
	}
	ScoreRange_value = map[string]int32{
		"anything":   0,
		"includeMin": 1,
		"includeMax": 2,
	}
...
func (x ScoreRange) Enum() *ScoreRange {
	p := new(ScoreRange)
	*p = x
	return p
}
...
func (ScoreRange) Descriptor() protoreflect.EnumDescriptor {
	return file_config_product_v1_level_confirm_proto_enumTypes[0].Descriptor()
}

func (ScoreRange) Type() protoreflect.EnumType {
	return &file_config_product_v1_level_confirm_proto_enumTypes[0]
}

func (x ScoreRange) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ScoreRange.Descriptor instead.
func (ScoreRange) EnumDescriptor() ([]byte, []int) {
...
const (
	IsNeedPm__         IsNeedPm = 0
	IsNeedPm_NeedPm    IsNeedPm = 1
	IsNeedPm_NotNeedPm IsNeedPm = 2
)

// Enum value maps for IsNeedPm.
var (
	IsNeedPm_name = map[int32]string{
		0: "_",
		1: "NeedPm",
		2: "NotNeedPm",
	}
	IsNeedPm_value = map[string]int32{
		"_":         0,
		"NeedPm":    1,
		"NotNeedPm": 2,
	}
...
func (x IsNeedPm) Enum() *IsNeedPm {
	p := new(IsNeedPm)
	*p = x
	return p
}

func (x IsNeedPm) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IsNeedPm) Descriptor() protoreflect.EnumDescriptor {
	return file_config_product_v1_level_confirm_proto_enumTypes[1].Descriptor()
}

func (IsNeedPm) Type() protoreflect.EnumType {
	return &file_config_product_v1_level_confirm_proto_enumTypes[1]
}

func (x IsNeedPm) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IsNeedPm.Descriptor instead.
func (IsNeedPm) EnumDescriptor() ([]byte, []int) {
	return file_config_product_v1_level_confirm_proto_rawDescGZIP(), []int{1}
}

// 是否委派PMl(1:是 2：否)
type IsNeedPml int32

const (
	IsNeedPml_NotSureIsNeedPml IsNeedPml = 0
	IsNeedPml_NeedPml          IsNeedPml = 1
	IsNeedPml_NotNeedPml       IsNeedPml = 2
)

// Enum value maps for IsNeedPml.
var (
	IsNeedPml_name = map[int32]string{
		0: "NotSureIsNeedPml",
		1: "NeedPml",
		2: "NotNeedPml",
	}
	IsNeedPml_value = map[string]int32{
		"NotSureIsNeedPml": 0,
		"NeedPml":          1,
		"NotNeedPml":       2,
	}
...
func (x IsNeedPml) Enum() *IsNeedPml {
	p := new(IsNeedPml)
	*p = x
	return p
}

func (x IsNeedPml) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IsNeedPml) Descriptor() protoreflect.EnumDescriptor {
	return file_config_product_v1_level_confirm_proto_enumTypes[2].Descriptor()
}

func (IsNeedPml) Type() protoreflect.EnumType {
	return &file_config_product_v1_level_confirm_proto_enumTypes[2]
}

func (x IsNeedPml) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IsNeedPml.Descriptor instead.
func (IsNeedPml) EnumDescriptor() ([]byte, []int) {
...
type LevelConfirmInfo struct {
	...
	ScoreRange    ScoreRange `protobuf:"varint,5,opt,name=ScoreRange,proto3,enum=config.ScoreRange" json:"ScoreRange"` // "得分区间包含关系（1：左闭右开，2：左开右闭）"
	IsNeedPm      IsNeedPm   `protobuf:"varint,6,opt,name=IsNeedPm,proto3,enum=config.IsNeedPm" json:"IsNeedPm"`       // "是否委派PM(1:是 2：否)"
	...
	IsNeedPml     IsNeedPml  `protobuf:"varint,10,opt,name=IsNeedPml,proto3,enum=config.IsNeedPml" json:"IsNeedPml"`   // "是否需要项目负责人(1:是 2：否)"
...
func (x *LevelConfirmInfo) GetScoreRange() ScoreRange {
	if x != nil {
		return x.ScoreRange
	}
	return ScoreRange_anything
}

func (x *LevelConfirmInfo) GetIsNeedPm() IsNeedPm {
	if x != nil {
		return x.IsNeedPm
	}
	return IsNeedPm__
...
func (x *LevelConfirmInfo) GetIsNeedPml() IsNeedPml {
	if x != nil {
		return x.IsNeedPml
	}
	return IsNeedPml_NotSureIsNeedPml
}
...
type CreateLevelConfirmReq struct {
	...
	ScoreRange    ScoreRange `protobuf:"varint,4,opt,name=ScoreRange,proto3,enum=config.ScoreRange" json:"ScoreRange"` // "得分区间包含关系（1：左闭右开，2：左开右闭）"
	IsNeedPm      IsNeedPm   `protobuf:"varint,5,opt,name=IsNeedPm,proto3,enum=config.IsNeedPm" json:"IsNeedPm"`       // "是否委派PM(1:是 2：否)"
	...
	IsNeedPml     IsNeedPml  `protobuf:"varint,9,opt,name=IsNeedPml,proto3,enum=config.IsNeedPml" json:"IsNeedPml"`    // "是否需要项目负责人(1:是 2：否)"
...
func (x *CreateLevelConfirmReq) GetScoreRange() ScoreRange {
	if x != nil {
		return x.ScoreRange
	}
	return ScoreRange_anything
...
func (x *CreateLevelConfirmReq) GetIsNeedPm() IsNeedPm {
	if x != nil {
		return x.IsNeedPm
	}
	return IsNeedPm__
...
func (x *CreateLevelConfirmReq) GetIsNeedPml() IsNeedPml {
	if x != nil {
		return x.IsNeedPml
	}
	return IsNeedPml_NotSureIsNeedPml
...
func (x *ModifyLevelConfirmReq) GetScoreRange() ScoreRange {
	if x != nil {
		return x.ScoreRange
	}
	return ScoreRange_anything
...
func (x *ModifyLevelConfirmReq) GetIsNeedPm() IsNeedPm {
	if x != nil {
		return x.IsNeedPm
	}
	return IsNeedPm__
...
func (x *ModifyLevelConfirmReq) GetIsNeedPml() IsNeedPml {
	if x != nil {
		return x.IsNeedPml
	}
	return IsNeedPml_NotSureIsNeedPml
...
var file_config_product_v1_level_confirm_proto_rawDesc = []byte{
	...
	0xbd, 0x03, 0x0a, 0x10, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d,
	...
	0x12, 0x32, 0x0a, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x05,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x3c, 0x0a, 0x0c, 0x4c,
	0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0c, 0x4c, 0x65, 0x76,
	0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x22, 0x8c, 0x01, 0x0a, 0x16, 0x47, 0x65,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72,
	0x6d, 0x52, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x09, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x44, 0x61,
	0x74, 0x61, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x2e, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x82, 0x03, 0x0a, 0x15, 0x4d, 0x6f, 0x64,
	0x69, 0x66, 0x79, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x52,
	0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x4d,
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x4d, 0x61, 0x78, 0x12, 0x32,
	0x0a, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x12, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x53, 0x63, 0x6f, 0x72,
	0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x61, 0x6e,
	0x67, 0x65, 0x12, 0x2c, 0x0a, 0x08, 0x49, 0x73, 0x4e, 0x65, 0x65, 0x64, 0x50, 0x6d, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x49, 0x73,
	0x4e, 0x65, 0x65, 0x64, 0x50, 0x6d, 0x52, 0x08, 0x49, 0x73, 0x4e, 0x65, 0x65, 0x64, 0x50, 0x6d,
	...
	,
	...
	,
...
var file_config_product_v1_level_confirm_proto_goTypes = []interface{}{
	(ScoreRange)(0),                // 0: config.ScoreRange
	(IsNeedPm)(0),                  // 1: config.IsNeedPm
	(IsNeedPml)(0),                 // 2: config.IsNeedPml
...
var file_config_product_v1_level_confirm_proto_depIdxs = []int32{
	0,  // 0: config.LevelConfirmInfo.ScoreRange:type_name -> config.ScoreRange
	1,  // 1: config.LevelConfirmInfo.IsNeedPm:type_name -> config.IsNeedPm
	2,  // 2: config.LevelConfirmInfo.IsNeedPml:type_name -> config.IsNeedPml
	0,  // 3: config.CreateLevelConfirmReq.ScoreRange:type_name -> config.ScoreRange
	1,  // 4: config.CreateLevelConfirmReq.IsNeedPm:type_name -> config.IsNeedPm
	2,  // 5: config.CreateLevelConfirmReq.IsNeedPml:type_name -> config.IsNeedPml
	...
	0,  // 11: config.ModifyLevelConfirmReq.ScoreRange:type_name -> config.ScoreRange
	1,  // 12: config.ModifyLevelConfirmReq.IsNeedPm:type_name -> config.IsNeedPm
	2,  // 13: config.ModifyLevelConfirmReq.IsNeedPml:type_name -> config.IsNeedPml
