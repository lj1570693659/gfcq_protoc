...
const (
	...
	ScoreRangeEnum_includeMinMax    ScoreRangeEnum = 3
	ScoreRangeEnum_notIncludeMinMax ScoreRangeEnum = 4
)
...
type LevelConfirmInfo struct {
	...
	Name          string         `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name,omitempty"`                                         // "项目优先级"
	ScoreMin      float32        `protobuf:"fixed32,3,opt,name=ScoreMin,proto3" json:"ScoreMin,omitempty"`                               // "得分下限"
	ScoreMax      float32        `protobuf:"fixed32,4,opt,name=ScoreMax,proto3" json:"ScoreMax,omitempty"`                               // "得分上线"
	ScoreRange    ScoreRangeEnum `protobuf:"varint,5,opt,name=ScoreRange,proto3,enum=config.ScoreRangeEnum" json:"ScoreRange,omitempty"` // "得分区间包含关系（1：左闭右开，2：左开右闭）"
	IsNeedPm      IsNeedPmEnum   `protobuf:"varint,6,opt,name=IsNeedPm,proto3,enum=config.IsNeedPmEnum" json:"IsNeedPm,omitempty"`       // "是否委派PM(1:是 2：否)"
	PmDemand      string         `protobuf:"bytes,7,opt,name=PmDemand,proto3" json:"PmDemand,omitempty"`                                 // "pm要求"
	ProductDemand string         `protobuf:"bytes,8,opt,name=ProductDemand,proto3" json:"ProductDemand,omitempty"`                       // "项目工作相关要求"
	MonitDemand   string         `protobuf:"bytes,9,opt,name=MonitDemand,proto3" json:"MonitDemand,omitempty"`                           // "监控要求"
	IsNeedPml     IsNeedPmlEnum  `protobuf:"varint,10,opt,name=IsNeedPml,proto3,enum=config.IsNeedPmlEnum" json:"IsNeedPml,omitempty"`   // "是否需要项目负责人(1:是 2：否)"
	Remark        string         `protobuf:"bytes,11,opt,name=Remark,proto3" json:"Remark,omitempty"`                                    // "预留备注说明信息"
	CreateTime    string         `protobuf:"bytes,12,opt,name=CreateTime,proto3" json:"CreateTime,omitempty"`                            // "新增数据时间"
	UpdateTime    string         `protobuf:"bytes,13,opt,name=UpdateTime,proto3" json:"UpdateTime,omitempty"`                            // "最新更新数据"
}
...
type CreateLevelConfirmReq struct {
	...
	Name          string         `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`                                         // "项目优先级"
	ScoreMin      float32        `protobuf:"fixed32,2,opt,name=ScoreMin,proto3" json:"ScoreMin,omitempty"`                               // "得分下限"
	ScoreMax      float32        `protobuf:"fixed32,3,opt,name=ScoreMax,proto3" json:"ScoreMax,omitempty"`                               // "得分上线"
	ScoreRange    ScoreRangeEnum `protobuf:"varint,4,opt,name=ScoreRange,proto3,enum=config.ScoreRangeEnum" json:"ScoreRange,omitempty"` // "得分区间包含关系（1：左闭右开，2：左开右闭）"
	IsNeedPm      IsNeedPmEnum   `protobuf:"varint,5,opt,name=IsNeedPm,proto3,enum=config.IsNeedPmEnum" json:"IsNeedPm,omitempty"`       // "是否委派PM(1:是 2：否)"
	PmDemand      string         `protobuf:"bytes,6,opt,name=PmDemand,proto3" json:"PmDemand,omitempty"`                                 // "pm要求"
	ProductDemand string         `protobuf:"bytes,7,opt,name=ProductDemand,proto3" json:"ProductDemand,omitempty"`                       // "项目工作相关要求"
	MonitDemand   string         `protobuf:"bytes,8,opt,name=MonitDemand,proto3" json:"MonitDemand,omitempty"`                           // "监控要求"
	IsNeedPml     IsNeedPmlEnum  `protobuf:"varint,9,opt,name=IsNeedPml,proto3,enum=config.IsNeedPmlEnum" json:"IsNeedPml,omitempty"`    // "是否需要项目负责人(1:是 2：否)"
	Remark        string         `protobuf:"bytes,10,opt,name=Remark,proto3" json:"Remark,omitempty"`                                    // "预留备注说明信息"
}
...
type CreateLevelConfirmRes struct {
	...
	LevelConfirm *LevelConfirmInfo `protobuf:"bytes,1,opt,name=LevelConfirm,proto3" json:"LevelConfirm,omitempty"`
}
...
type GetListLevelConfirmReq struct {
	...
	LevelConfirm *LevelConfirmInfo `protobuf:"bytes,3,opt,name=LevelConfirm,proto3" json:"LevelConfirm,omitempty"`
}
...
type GetListLevelConfirmRes struct {
	...
	Data      []*LevelConfirmInfo `protobuf:"bytes,4,rep,name=Data,proto3" json:"Data,omitempty"`
}
...
var file_config_product_v1_level_confirm_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x4d, 0x73, 0x67, 0x2a, 0x67, 0x0a, 0x0e, 0x53, 0x63,
	...
	,
	...
	,
	...
	,
