...
type SendTextMsgReq struct {
	...
	Touser                 []string     `protobuf:"bytes,1,rep,name=Touser,proto3" json:"Touser,omitempty"`   // 指定接收消息的成员，成员ID列表（多个接收者用‘|’分隔，最多支持1000个）。 特殊情况：指定为"@all"，则向该企业应用的全部成员发送
	Toparty                []string     `protobuf:"bytes,2,rep,name=Toparty,proto3" json:"Toparty,omitempty"` // 指定接收消息的部门，部门ID列表，多个接收者用‘|’分隔，最多支持100个。
	...
	Safe                   int32        `protobuf:"varint,6,opt,name=Safe,proto3" json:"Safe,omitempty"`
	EnableIdTrans          int32        `protobuf:"varint,7,opt,name=EnableIdTrans,proto3" json:"EnableIdTrans,omitempty"`
	EnableDuplicateCheck   int32        `protobuf:"varint,8,opt,name=EnableDuplicateCheck,proto3" json:"EnableDuplicateCheck,omitempty"`
	DuplicateCheckInterval int32        `protobuf:"varint,9,opt,name=DuplicateCheckInterval,proto3" json:"DuplicateCheckInterval,omitempty"`
	Content                *TextContent `protobuf:"bytes,10,opt,name=Content,proto3" json:"Content,omitempty"`
}

func (x *SendTextMsgReq) Reset() {
	*x = SendTextMsgReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_wechat_v1_checkin_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendTextMsgReq) Descriptor() ([]byte, []int) {
	return file_wechat_v1_checkin_proto_rawDescGZIP(), []int{8}
}

func (x *SendTextMsgReq) GetTouser() []string {
	if x != nil {
		return x.Touser
	}
	return nil
...
func (x *SendTextMsgReq) GetToparty() []string {
	if x != nil {
		return x.Toparty
	}
	return nil
...
func (x *SendTextMsgReq) GetTotag() string {
	if x != nil {
		return x.Totag
	}
	return ""
...
func (x *SendTextMsgReq) GetMsgtype() string {
	if x != nil {
		return x.Msgtype
	}
	return ""
...
func (x *SendTextMsgReq) GetAgentid() int32 {
	if x != nil {
		return x.Agentid
	}
	return 0
...
func (x *SendTextMsgReq) GetSafe() int32 {
	if x != nil {
		return x.Safe
	}
	return 0
...
func (x *SendTextMsgReq) GetEnableIdTrans() int32 {
	if x != nil {
		return x.EnableIdTrans
	}
	return 0
}

func (x *SendTextMsgReq) GetEnableDuplicateCheck() int32 {
	if x != nil {
		return x.EnableDuplicateCheck
	}
	return 0
}

func (x *SendTextMsgReq) GetDuplicateCheckInterval() int32 {
	if x != nil {
		return x.DuplicateCheckInterval
	}
	return 0
}

func (x *SendTextMsgReq) GetContent() *TextContent {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *TextContent) Reset() {
	*x = TextContent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_wechat_v1_checkin_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TextContent) Descriptor() ([]byte, []int) {
	return file_wechat_v1_checkin_proto_rawDescGZIP(), []int{9}
}
...
type SendMsgRes struct {
	...
	InvalidUser    string `protobuf:"bytes,3,opt,name=InvalidUser,proto3" json:"InvalidUser,omitempty"`
	InvalidParty   string `protobuf:"bytes,4,opt,name=InvalidParty,proto3" json:"InvalidParty,omitempty"`
	InvalidTag     string `protobuf:"bytes,5,opt,name=InvalidTag,proto3" json:"InvalidTag,omitempty"`
	UnlicensedUser string `protobuf:"bytes,6,opt,name=UnlicensedUser,proto3" json:"UnlicensedUser,omitempty"`
...
func (x *SendMsgRes) Reset() {
	*x = SendMsgRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_wechat_v1_checkin_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendMsgRes) Descriptor() ([]byte, []int) {
	return file_wechat_v1_checkin_proto_rawDescGZIP(), []int{10}
}

func (x *SendMsgRes) GetErrCode() int32 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
func (x *SendMsgRes) GetErrMsg() string {
	if x != nil {
		return x.ErrMsg
	}
	return ""
...
func (x *SendMsgRes) GetInvalidUser() string {
	if x != nil {
		return x.InvalidUser
	}
	return ""
}

func (x *SendMsgRes) GetInvalidParty() string {
	if x != nil {
		return x.InvalidParty
	}
	return ""
}

func (x *SendMsgRes) GetInvalidTag() string {
	if x != nil {
		return x.InvalidTag
	}
	return ""
...
func (x *SendMsgRes) GetUnlicensedUser() string {
	if x != nil {
		return x.UnlicensedUser
	}
	return ""
}

func (x *SendMsgRes) GetMsgID() string {
	if x != nil {
		return x.MsgID
	}
	return ""
...
func (x *SendMsgRes) GetResponseCode() string {
	if x != nil {
...
var file_wechat_v1_checkin_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_wechat_v1_checkin_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_wechat_v1_checkin_proto_goTypes = []interface{}{
	...
	(*SendTextMsgReq)(nil),           // 8: common.SendTextMsgReq
	(*TextContent)(nil),              // 9: common.TextContent
	(*SendMsgRes)(nil),               // 10: common.SendMsgRes
}
var file_wechat_v1_checkin_proto_depIdxs = []int32{
	...
	9,  // 6: common.SendTextMsgReq.Content:type_name -> common.TextContent
	0,  // 7: common.WechatCheckIn.GetUserCheckInDayData:input_type -> common.GetUserCheckInDayDataReq
	8,  // 8: common.WechatCheckIn.SendMsg:input_type -> common.SendTextMsgReq
	6,  // 9: common.WechatCheckIn.GetUserCheckInDayData:output_type -> common.GetUserCheckInDayDataRes
	10, // 10: common.WechatCheckIn.SendMsg:output_type -> common.SendMsgRes
...
func file_wechat_v1_checkin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wechat_v1_checkin_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wechat_v1_checkin_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_wechat_v1_checkin_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
...
type WechatCheckInClient interface {
	...
	SendMsg(ctx context.Context, in *SendTextMsgReq, opts ...grpc.CallOption) (*SendMsgRes, error)
}
...
func (c *wechatCheckInClient) SendMsg(ctx context.Context, in *SendTextMsgReq, opts ...grpc.CallOption) (*SendMsgRes, error) {
	out := new(SendMsgRes)
	err := c.cc.Invoke(ctx, "/common.WechatCheckIn/SendMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WechatCheckInServer interface {
	...
	SendMsg(context.Context, *SendTextMsgReq) (*SendMsgRes, error)
}
...
func (*UnimplementedWechatCheckInServer) SendMsg(context.Context, *SendTextMsgReq) (*SendMsgRes, error) {
...
func _WechatCheckIn_SendMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendTextMsgReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WechatCheckInServer).SendMsg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/common.WechatCheckIn/SendMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WechatCheckInServer).SendMsg(ctx, req.(*SendTextMsgReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WechatCheckIn_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendMsg",
			Handler:    _WechatCheckIn_SendMsg_Handler,
		},
	},
